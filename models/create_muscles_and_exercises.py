...
# example_exercise = Exercise(name="Squat", force="PUSH", description="A compound exercise that targets the legs and glutes.",
...
for m in all_muscles:
    ...
    new_muscle = Muscle(name=m)
    # Add the muscle to the session
    local_session.add(new_muscle)
